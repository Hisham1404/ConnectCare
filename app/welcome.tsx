    ...
    <View style={styles.container}>
      ...
      >
          ...
          <View style={styles.demoSection}>
            ...
            <View style={styles.credentialsBox}>
              ...
              <View style={styles.credentialItem}>
                <Text style={styles.credentialLabel}>Demo Mode:</Text>
                <Text style={styles.credentialValue}>Direct access enabled</Text>
              </View>
              <View style={styles.credentialItem}>
                <Text style={styles.credentialLabel}>Full Auth:</Text>
                <Text style={styles.credentialValue}>Available via sign-up</Text>
              </View>
              <Text style={styles.credentialsNote}>
                * Choose demo mode for instant access or create an account for full features
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.finalCtaSection}>
          ...
          >
            <Text style={styles.authButtonText}>Create Account / Sign In</Text>
          </FeedbackButton>
